...
const PROJECTS: Project[] = [
  {
    ...
    subtitle: 'Plataforma de matching entre estudantes e vagas',
    description:
      'Plataforma web que conecta estudantes do ensino técnico a oportunidades de emprego e estágio. O frontend foi construído em React + TypeScript com foco em UX de busca e candidatura. O backend foi desenvolvido em Django REST Framework com autenticação JWT, endpoints de vagas, candidaturas e perfis de usuário.',
    stack: ['React', 'TypeScript', 'Tailwind CSS', 'Django', 'Django REST Framework', 'JWT'],
    category: 'Full-Stack',
    year: '2026',
    highlights: [
      'API REST em Django com autenticação JWT — login, registro e rotas protegidas por token.',
      'Sistema de candidatura: estudante aplica para vaga, empresa visualiza candidatos por vaga.',
      'Separação clara entre frontend React e backend Django desacoplado via API.',
    ],
    liveUrl: '',
  ...
  },
  {
    ...
    description:
      'E-commerce completo para confeitaria artesanal com catálogo por categorias, carrinho de compras, checkout com cálculo de frete via CEP e pagamento via PIX com QR Code. Inclui painel administrativo com dashboard de vendas, gestão de produtos e exportação de dados em CSV.',
    stack: ['React', 'TypeScript', 'Tailwind CSS', 'Supabase', 'Vite'],
    category: 'Frontend / Backend',
    year: '2026',
    highlights: [
      'Carrinho de compras com persistência em localStorage para recuperação de sessão abandonada.',
      'Integração com API dos Correios para cálculo de frete por CEP, peso e dimensões.',
      'Geração de QR Code PIX e confirmação de pagamento via webhook do Mercado Pago.',
    ],
  ...
  },
  {
    ...
    codeName: 'ice-frost',
    title: 'ICE FROST',
    subtitle: 'Sistema de gestão para sorveteria',
    description:
      'Sistema de gestão interno desenvolvido em Django + SQLite para uma sorveteria artesanal. Cobre cadastro de produtos, controle de fornecedores e estoque. Projeto desenvolvido como avaliação formativa do curso técnico de Desenvolvimento de Sistemas no SENAI-SP.',
    stack: ['Django', 'SQLite', 'Python', 'HTML', 'CSS'],
    category: 'Backend / Frontend',
    year: '2026',
    highlights: [
      'CRUD completo de produtos e fornecedores com Django ORM e SQLite.',
      'Interface administrativa gerada com Django Templates — sem framework frontend externo.',
      'Primeiro projeto Django completo com models, views, urls e templates integrados.',
    ],
    liveUrl: '',
  ...
  },
  {
    ...
    subtitle: 'Sistema de cadastro e gerenciamento de equipamentos',
    description:
      'Sistema de cadastro e gerenciamento de máquinas industriais desenvolvido em Django + SQLite. Criado para o simulado da SAEP — Sistema de Avaliação de Educação Profissional do curso técnico de Desenvolvimento de Sistemas no SENAI-SP.',
    stack: ['Django', 'SQLite', 'Python', 'HTML', 'CSS'],
    category: 'Backend / Frontend',
    year: '2026',
    highlights: [
      'CRUD de máquinas com campos de identificação, setor e status operacional.',
      'Validações de formulário no backend com Django Forms.',
      'Desenvolvido sob condições de simulado — prazo fechado, sem consulta externa.',
    ],
    liveUrl: '',
